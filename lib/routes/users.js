...
router
    ...
    .post('/validate', ensureAuth, bodyParser, (req, res) => { // um, just get rid of next
    ...
    .post('/signup', bodyParser, (req, res, next) => {
        ...
        userModel
            ...
            .then(count => {
                ...
                // I probably would have used TitleCase because models are "classes"
            ...
            .then(user => {
                ...
                newPort.save();
                // new Portfolio and Token sign should be done in parallel
    ...
    .delete('/', ensureAuth, ensureRole(['admin']), bodyParser, (req, res, next) => {
        ...
        userModel
            .findOne({username})
            // you need to use .select() to prevent password hash
            // from being returned:
            .select('-password')
            .then(user => {
                return user.remove();
            ...
            .then(removedPortfolio => {
                res.send({removedUser,removedPortfolio});
            })
            .catch(next);
    });
